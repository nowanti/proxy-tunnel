...
-- 配置代理获取
local proxy_url = "http://service.ipzan.com/core-extract?num=%d&no=20211021114537654079&minute=1&format=txt&repeat=1&protocol=1&pool=quality&mode=whitelist&secret=1d2gcqqo8"
-- -------------------------------------
